...
### Assignment 3: Use Pandas to Read a CSV File Containing Stock Market Data and Calculate the Moving Average

---

### Lecture Content: Error and Exception Handling
...
### Assignment: Reading and Processing Stock Market Data with Pandas

#### Problem Statement:
Develop an application that reads stock market data from a CSV file, processes the data to calculate the moving average, and generates a summary report.
...
#### Starter Code:
```python
# Starter code for stock market data processing application
import pandas as pd
...
2. **Step 2**: Process the data to calculate the moving average of the closing prices.
   - Use the `rolling()` and `mean()` methods to calculate the moving average.
3. **Step 3**: Generate a summary report that includes key statistics of the processed data.
   - Use the `describe()` method to generate the summary report.

#### Criteria for Success and Evaluation:
1. **Data Reading**: The application should correctly read the stock market data from the CSV file.
2. **Data Processing**: The application should accurately calculate the moving average of the closing prices.
3. **Summary Report**: The application should generate an accurate summary report with key statistics.
...
#### Assignment: Building an F1 Race Track Simulator

##### Problem Statement:
Develop a simulation that reads lap times from a CSV file, calculates average speed, and generates a performance report.
...
##### Starter Code:
```python
# Starter code for F1 race track simulator
import pandas as pd
...
def calculate_average_speed(data):
    data['Speed'] = 500 / data['Lap Time']
    data['Average Speed'] = data['Speed'].mean()
    return data
